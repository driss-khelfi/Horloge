...
if string_hour in hour:
 print("a la bonne heure")
 my_alarm.append(string_hour)
 string_minute = input("Entrez votre minute: ")
 if str(string_minute) in minute:
    print("pas de minutes à perdre!")
    my_alarm.append(string_minute)
    string_second = input("Entrez votre seconde: ")
    if str(string_second) in second:
     print("plus de secondes à perdre")
     my_alarm.append(string_second)
     print("your alarm is set on", str(string_hour.zfill(2)),":",str(string_minute.zfill(2)),":", str(string_second.zfill(2)))
     
    else:
     print("c'est l'affaire d'une seconde")
 else:
    print("minute papillon!")
else:
 print("quelle est cette heure ?")
